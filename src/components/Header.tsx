  ...
  return (
    <header className="sticky top-0 z-[950] flex-shrink-0" style={{ background: "hsl(var(--header-bg))" }}>
      ...
      <div className="border-b" style={{ borderColor: "hsl(var(--header-border))" }}>
        <div className="w-full pl-0 sm:pl-2 pr-3 sm:pr-5">
          <div className="flex items-center h-12 gap-2">

            {/* 로고 */}
            <div
              className="flex items-center gap-2 cursor-pointer select-none flex-shrink-0 ml-0 sm:ml-2"
              onClick={() => navigate("/")}
            >
              <img src={logoImg} alt="집다 로고" loading="eager" decoding="async" width={200} height={80} className="h-24 md:h-20 object-contain block mt-2" />
              <span
