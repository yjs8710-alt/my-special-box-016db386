            ...
            {isHome && isAuthorized && (
              <div className="hidden md:flex items-center ml-auto">
                <button
                  ...
                  className="flex items-center justify-center p-1 rounded-lg hover:bg-white/10 transition-colors"
                  aria-label="채팅 문의"
                  title="채팅 문의"
                >
                  <img src={iconChatNeon} alt="채팅 문의" className="w-16 h-16 object-contain" />
                </button>
              </div>
            )}
