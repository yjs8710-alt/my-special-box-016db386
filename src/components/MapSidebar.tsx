  ...
  <script>
    ...
    return (
      <div className="flex-1 min-w-0 flex flex-col border-l border-border/30 px-2 py-0.5 gap-0.5">
        ...
        {/* 1.5줄: 아이콘 배지 (도로명 우측 아래) */}
        <div className="flex items-center gap-1 justify-end flex-wrap min-h-0">
          {(() => {
            ...
            const ICON_MAP_INLINE: Record<string, IconBadge> = {
              수도: {
