...
const OptionSvgIcon = ({ name, size = 11 }: { name: string; size?: number }) => {
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    "애완동물가능": <svg width={s} height={s} viewBox="0 0 24 24" fill="currentColor"><ellipse cx="10.5" cy="15" rx="6" ry="3.5"/><circle cx="18" cy="10.5" r="3"/><ellipse cx="16.5" cy="7.8" rx="1.6" ry="2" transform="rotate(-15 16.5 7.8)"/><ellipse cx="21" cy="11.5" rx="0.9" ry="0.7"/><path d="M4.5 13.5 Q2.5 11 3.5 8.5" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" fill="none"/><rect x="14.5" y="18" width="2" height="3.5" rx="1" fill="currentColor"/><rect x="8" y="18" width="2" height="3.5" rx="1" fill="currentColor"/></svg>,
    "반려동물_가능": <svg width={s} height={s} viewBox="0 0 24 24" fill="currentColor"><ellipse cx="10.5" cy="15" rx="6" ry="3.5"/><circle cx="18" cy="10.5" r="3"/><ellipse cx="16.5" cy="7.8" rx="1.6" ry="2" transform="rotate(-15 16.5 7.8)"/><ellipse cx="21" cy="11.5" rx="0.9" ry="0.7"/><path d="M4.5 13.5 Q2.5 11 3.5 8.5" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" fill="none"/><rect x="14.5" y="18" width="2" height="3.5" rx="1" fill="currentColor"/><rect x="8" y="18" width="2" height="3.5" rx="1" fill="currentColor"/></svg>,
